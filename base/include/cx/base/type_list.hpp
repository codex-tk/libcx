...
template <typename... Ts> struct type_list {
    ...
    template <std::size_t I> using at = cx::mp::at<I, this_type>;
    ...
    using pop_back =
        cx::mp::pop_back<cx::mp::make_sequence<sizeof...(Ts) - 1>, this_type>;
    ...
    template <template <typename...> class U> struct rebind {
        using other = U<Ts...>;
    };
};
} // namespace cx
