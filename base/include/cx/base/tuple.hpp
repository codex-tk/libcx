...
struct values<cx::mp::sequence<Is...>, Ts...> : value<Is, Ts>...
//	: value< Is, typename cx::mp::at< Is, type_list< Ts ... >>::type > ...
{
    ...
    operator[](const std::integral_constant<std::size_t, I> &) {
        return static_cast<
                   value<I, typename cx::mp::at<I, type_list<Ts...>>::type> *>(
                   this)
            ->data;
    }
};

template <std::size_t I, typename T> T &get(value<I, T> &v) { return v.data; }
