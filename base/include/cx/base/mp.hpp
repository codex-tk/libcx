...
#ifndef __cx_base_mp_h__
#define __cx_base_mp_h__
...
struct _make_sequence : _make_sequence<I - 1, I - 1, S...> {};
...
template <std::size_t I, template <typename...> class TypeList, typename Head,
          typename... Ts>
struct at<I, TypeList<Head, Ts...>> : at<I - 1, TypeList<Ts...>> {};

template <template <typename...> class TypeList, typename Head, typename... Ts>
struct at<0, TypeList<Head, Ts...>> {
    using type = Head;
};

template <typename TypeList> using front = at<0, TypeList>;
...
template <template <typename...> class TypeList, typename... Us, typename... Ts>
...
template <std::size_t... I, template <typename...> class TypeList,
          typename... Ts>
...
template <typename T, template <typename...> class F> struct transform;

template <template <typename...> class TypeList, template <typename...> class F,
          typename... Ts>
