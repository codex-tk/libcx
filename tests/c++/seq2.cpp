...
TEST( make_seq , view ) {
    std::cout << cx::type_name( make_seq0<0>::type{} ) << std::endl; // char
    std::cout << cx::type_name( make_seq0<1>::type{} ) << std::endl; // int
    std::cout << cx::type_name( make_seq0<2>::type{} ) << std::endl; // int
    std::cout << cx::type_name( make_seq0<3>::type{} ) << std::endl; // int
    std::cout << cx::type_name( make_seq0<4>::type{} ) << std::endl; // int
    std::cout << cx::type_name( make_seq0<5>::type{} ) << std::endl; // int
}

TEST( make_seq , view2 ) {
    std::cout << cx::type_name( make_seq1<0>::type{} ) << std::endl; // char
    // make_seq1< 0 , s ... > - > make_seq1< 0 , none > -> seq<>

    std::cout << cx::type_name( make_seq1<1>::type{} ) << std::endl; // int
    // make_seq1< max = 1 , s ... = none  > ->  seq< 1 -1 , 1 -1 , none > -> seq< 1 -1 , 1 -1  > 

    std::cout << cx::type_name( make_seq1<2>::type{} ) << std::endl; // int
    std::cout << cx::type_name( make_seq1<3>::type{} ) << std::endl; // int
    std::cout << cx::type_name( make_seq1<4>::type{} ) << std::endl; // int
    std::cout << cx::type_name( make_seq1<5>::type{} ) << std::endl; // int
}
...
TEST( make_seq , view3 ) {
    std::cout << cx::type_name( sample::make_seq<0>::type{} ) << std::endl; // char
    // make_seq< 0 , s ... > - > make_seq1< 0 , none > -> seq<>

    std::cout << cx::type_name( sample::make_seq<1>::type{} ) << std::endl; // int
    // make_seq< max = 1 , s ... = none  > ->  make_seq< 0 , 0 , none > -> seq<0>

    std::cout << cx::type_name( sample::make_seq<2>::type{} ) << std::endl; // int
    // make_seq< max = 2 , s ... = none  > -> : make_seq< 1 , 1 > -> : make_seq< 0 , 1  > -> seq< 0 , 1 >

    std::cout << cx::type_name( sample::make_seq<3>::type{} ) << std::endl; // int
    // make_seq< 3 , ... > - > make_seq< 2 , 2 , ... > -> make_seq< 1 , 1 , 2 , ... > 
    //-> make_seq< 0 , 0 , 1, 2 , ... > -> seq< 0 , 1 , 2 >
    
    std::cout << cx::type_name( sample::make_seq<4>::type{} ) << std::endl; // int
    std::cout << cx::type_name( sample::make_seq<5>::type{} ) << std::endl; // int

    std::cout << cx::type_name( sample::make_seq<6>::type{} ) << std::endl;
}
/*
TEST( tmp , type_list ) {
